...
using GuildWarVector = std::vector<uint32_t>; // Adicionado para definir o tipo GuildWarVector
...
class IOLoginData
{
	public:
		...
		static GuildWarVector getWarList(uint32_t guildId); // Adicione esta linha
