...
enum SpellGroup_t : uint8_t {
	...
	SPELLGROUP_CONJURE = 9,
	SPELLGROUP_ULTIMATE = 10,
};
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SPECIALSKILL_CRITICALHITCHANCE = 47,
	CONDITION_PARAM_SPECIALSKILL_CRITICALHITAMOUNT = 48,
	CONDITION_PARAM_SPECIALSKILL_LIFELEECHCHANCE = 49,
	CONDITION_PARAM_SPECIALSKILL_LIFELEECHAMOUNT = 50,
	CONDITION_PARAM_SPECIALSKILL_MANALEECHCHANCE = 51,
	CONDITION_PARAM_SPECIALSKILL_MANALEECHAMOUNT = 52,
