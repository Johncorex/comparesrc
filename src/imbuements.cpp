				...
				if (strcasecmp(type.c_str(), "item") == 0) {
					...
					if (strcasecmp(effecttype.c_str(), "skill") == 0) {
						...
						if (tmpStrValue == "sword") {
							...
							usenormalskill = 3;
							skillId = SPECIALSKILL_CRITICALHITAMOUNT;
						} else if (tmpStrValue == "lifeleech") {
							usenormalskill = 3;
							skillId = SPECIALSKILL_LIFELEECHAMOUNT;
						} else if (tmpStrValue == "manaleech") {
							usenormalskill = 3;
							skillId = SPECIALSKILL_MANALEECHAMOUNT;
						} else {
