...
enum MagicEffectClasses : uint8_t {
	...
	CONST_ME_BLUECHAIN = 200,
	CONST_ME_ORANGECHAIN = 201,
	CONST_ME_GREENCHAIN = 202,
	CONST_ME_PURPLECHAIN = 203,
	CONST_ME_GREYCHAIN = 204,
	CONST_ME_YELLOWCHAIN = 205,
	CONST_ME_YELLOWSPARKLES = 206,
	// 207 is empty
		CONST_ME_FAEEXPLOSION = 208,
		CONST_ME_FAECOMING = 209,
		CONST_ME_FAEGOING = 210,
		// 211 is empty
		CONST_ME_BIGCLOUDSSINGLESPACE = 212,
		CONST_ME_STONESSINGLESPACE = 213,
		// 214 is empty
		CONST_ME_BLUEGHOST = 215,
		// 216 is empty
		CONST_ME_POINTOFINTEREST = 217,
		CONST_ME_MAPEFFECT = 218,
		CONST_ME_PINKSPARK = 219,
		CONST_ME_FIREWORK_GREEN = 220,
		CONST_ME_FIREWORK_ORANGE = 221,
		CONST_ME_FIREWORK_PURPLE = 222,
		CONST_ME_FIREWORK_TURQUOISE = 223,
		// 224 is empty
		CONST_ME_THECUBE = 225,
		CONST_ME_DRAWINK = 226,
		CONST_ME_PRISMATICSPARKLES = 227,
		CONST_ME_THAIAN = 228,
		CONST_ME_THAIANGHOST = 229,
		CONST_ME_GHOSTSMOKE = 230,
		// 231 is empty
		CONST_ME_FLOATINGBLOCK = 232,
		CONST_ME_BLOCK = 233,
		CONST_ME_ROOTING = 234,
		CONST_ME_SUNPRIEST = 235,
		CONST_ME_WERELION = 236,
		CONST_ME_GHOSTLYSCRATCH = 237,
		CONST_ME_GHOSTLYBITE = 238,
		CONST_ME_BIGSCRATCHING = 239,
		CONST_ME_SLASH = 240,
		CONST_ME_BITE = 241,
		// 242 is empty
		CONST_ME_CHIVALRIOUSCHALLENGE = 243,
		CONST_ME_DIVINEDAZZLE = 244,
		CONST_ME_ELECTRICALSPARK = 245,
		CONST_ME_PURPLETELEPORT = 246,
		CONST_ME_REDTELEPORT = 247,
		CONST_ME_ORANGETELEPORT = 248,
		CONST_ME_GREYTELEPORT = 249,
		CONST_ME_LIGHTBLUETELEPORT = 250,


	CONST_ME_LAST = CONST_ME_LIGHTBLUETELEPORT,
};
...
enum Icons_t {
	...
	ICON_WITHIN_RESTING_AREA = 1<<27 //client 11.40+
};
